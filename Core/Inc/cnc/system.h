...
#define EXEC_LOCKED         bit(7) // bitmask 10000000

#define EXEC_FEED_DWELL     bit(8)
#define EXEC_TOOL_CHANGE    bit(9)
//
#define ST_IDLE_ENABLED     TRUE
#define ST_IDLE_DISABLED    FALSE
...
#define EXEC_ALARM_MOTION_DRIVERS             11
#define EXEC_ALARM_SPINDLE_CONTROL            12
...
#define EXEC_RAPID_OVR_COARSE_PLUS     bit(6)
#define EXEC_RAPID_OVR_COARSE_MINUS    bit(7)
//------------------------------------------------------------------------------
...
#define STATE_LOCKED        bit(7) // Sleep state.
...
extern volatile uint8_t save_pos;
extern float travels[N_AXIS] ;
extern uint32_t sys_distanse[N_AXIS];
